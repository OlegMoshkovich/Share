...
function SampleModelFileSelector({navigate, setIsDialogDisplayed}) {
  ...
  const modelPath = {
    Momentum: '/share/v/gh/bldrs-ai/test-models/main/ifc/Schependomlaan.ifc#c:60.45,-4.32,60.59,1.17,5.93,-3.77',
    Schneestock: '/share/v/gh/Swiss-Property-AG/Momentum-Public/main/Momentum.ifc#c:-38.64,12.52,35.4,-5.29,0.94,0.86',
    Eisvogel: '/share/v/gh/Swiss-Property-AG/Schneestock-Public/main/ZGRAGGEN.ifc#c:80.66,11.66,-94.06,6.32,2.93,-8.72',
    Seestrasse: '/share/v/gh/Swiss-Property-AG/Eisvogel-Public/main/EISVOGEL.ifc#c:107.36,8.46,156.67,3.52,2.03,16.71',
    Schependomlaan: '/share/v/gh/Swiss-Property-AG/Seestrasse-Public/main/SEESTRASSE.ifc#c:119.61,50.37,73.68,16.18,11.25,5.74',
    Structural: '/share/v/gh/bldrs-ai/test-models/main/ifc/openifcmodels/171210AISC_Sculpture_param.ifc',
  ...
  //   closeDialog()
  // }
  const handleSelect = (modelNumber, closeDialog) => {
    setSelected(modelNumber)
    window.removeEventListener('beforeunload', handleBeforeUnload)
    navigate({pathname: modelPath[modelNumber]})
    closeDialog()
  }
        ...
        Object.keys(modelPath).map((model, i) => {
          return (
            <Chip
              ...
              // onClick={() => console.log('i', modelPath[model])}
              color='primary'
            />
          )
        })
